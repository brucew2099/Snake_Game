...
namespace SnakeGame
{
    public partial class frmSnake : Form
    {
        ...
        private GameBoardFields[,] gameBoardField;
        private SnakeCoordinates[] snakeXY;
        ...
        { 
            ...
            // Move snake parts to the position of the previous ones
            ...
            // Draw part where the head used to be
            ...
            // See if the head hits the wall
            if (snakeXY[0].x == 0 || snakeXY[0].x == 11 || snakeXY[0].y == 0 || snakeXY[0].y == 11)
            {
                GameOver();
                picGameBoard.Refresh();
                return;
            ...
            // See if the head hits a bonus item
            if (gameBoardField[snakeXY[0].x, snakeXY[0].y] == GameBoardFields.Bonus)
            {
                ...
                // Snake length cannot be more than 92
                if (snakeLength < 92)
                {
                    Bonus();
                }
